...
class DiaryFilterDialog extends StatefulWidget {
  List dataList;
  DiaryFilterDialog(this.dataList);

  @override
  State<DiaryFilterDialog> createState() => _DiaryFilterDialogState(dataList);
}
...
class _DiaryFilterDialogState extends State<DiaryFilterDialog> {
  ...
  _DiaryFilterDialogState(this.addData) {
    if (addData[0]) {
