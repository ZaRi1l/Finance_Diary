...
class Cal3 extends StatefulWidget {
  const Cal3({super.key});

  @override
  State<Cal3> createState() => _Cal3State();
}

class _Cal3State extends State<Cal3> {
  ...
  calculate() {
    try {
      ...
      result[0] = top.toStringAsFixed(1);
      result[1] = (top - dif * 0.236).toStringAsFixed(1);
      result[2] = (top - dif * 0.382).toStringAsFixed(1);
      result[3] = (top - dif * 0.5).toStringAsFixed(1);
      result[4] = (top - dif * 0.618).toStringAsFixed(1);
      result[5] = (top - dif * 0.764).toStringAsFixed(1);
      result[6] = (top - dif * 1).toStringAsFixed(1);
      result[7] = (top - dif * 1.618).toStringAsFixed(1);
